 ...
 *
 * <p>协议固定使用 UTF-8、AES-128-ECB、PKCS padding 和标准 Base64。密钥按 MySQL
 * 两参数模式的规则折叠到 16 字节 AES 密钥。</p>
 */
public abstract class AESUtils {
    ...
    public static String decrypt(String encodedCipherText, String aesKey) {
    ...
    private static SecretKeySpec key(String aesKey) {
    ...
    private static void validateInput(String value, String aesKey) {
        if (value == null) {
